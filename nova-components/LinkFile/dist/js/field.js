...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-link-file', __webpack_require__(3));
  Vue.component('detail-link-file', __webpack_require__(6));
  Vue.component('form-link-file', __webpack_require__(9));
});
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", {}, [
    _c("div", { staticClass: "text-center w-full align-end" }, [
      _c(
        "a",
        {
          staticClass:
            "mt-4 cursor-pointer dim btn btn-link text-primary inline-flex items-center",
          attrs: { href: "/storage/" + _vm.field.value, target: "_blank" }
        },
        [
          _c(
            "svg",
          ...
          _vm._v(" "),
          _c("span", { staticClass: "class mt-1" }, [_vm._v("Descargar")])
        ]
      )
    ])
  ])
