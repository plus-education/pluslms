...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-grid-multiselect-belogs-to-many', __webpack_require__(3));
  Vue.component('detail-grid-multiselect-belogs-to-many', __webpack_require__(6));
  Vue.component('form-grid-multiselect-belogs-to-many', __webpack_require__(9));
});
