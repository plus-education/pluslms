...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('activity-comments', __webpack_require__(5));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue2_editor__ = __webpack_require__(8);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: { VueEditor: __WEBPACK_IMPORTED_MODULE_0_vue2_editor__["a" /* VueEditor */] },
    ...
    data: function data() {
        return {
            ...
            answer: null,
            answers: Object,
            customToolbar: [['font', "bold", "italic", "underline"], [{ list: "ordered" }, { list: "bullet" }], ["image"]]
        };
    },

    computed: {
        typeOfcomment: function typeOfcomment() {
    ...
    methods: {
        getComment: function getComment() {
            ...
            Nova.request().get('/commnets/activity/' + this.resourceId + '/' + this.typeOfcomment).then(function (response) {
        ...
        saveComment: function saveComment() {
            ...
            Nova.request().post('/commnets/activity/' + this.typeOfcomment, data).then(function (response) {
        ...
        returnToComments: function returnToComments() {
            this.comment = null;
        ...
        getAnswers: function getAnswers() {
            ...
            Nova.request().get('/commnets/answers/' + this.comment.id + '/').then(function (response) {
                _this3.answers = response.data;
            });
        },
        ...
        saveAnswer: function saveAnswer() {
            ...
            Nova.request().post('/commnets/storeAnswer/' + this.typeOfcomment, data).then(function (response) {
                _this4.answers.push(response.data);
            });
    ...
    !_vm.showAnswers
      ? _c(
          ...
          [
            _c(
              "div",
              { staticClass: "text-center shadow-md rounded-lg  mb-4 p-4" },
              [
            ...
            _vm._l(_vm.comments, function(comment) {
              return _c(
                "div",
                { staticClass: "mb-4 p-4  shadow-md rounded-lg" },
                [
                    ...
                    _c("div", { staticClass: "ml-2 flex-1" }, [
                      _c("div", { staticClass: "flex items-center" }, [
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "text-xs  bg-gray-200 ml-2 px-2 py-2 rounded-lg"
                          },
                          [
                            _vm._v(
                              "\n                            " +
                      ...
                      _c("div", { staticClass: "text-left" }, [
                        _c(
                          "button",
                          {
                            ...
                            on: {
                              click: function($event) {
                                return _vm.showComment(comment)
                              }
                            }
                          },
                          [
                            _c(
                              "div",
                              { staticClass: "flex items-center align-middle" },
                              [
                                _c("div", { staticClass: "flex-shrink" }, [
                                  _c(
                                    "svg",
                                    {
                                      staticClass: "w-6  text-blue-600",
                                      attrs: {
                                ...
                                _c(
                                  "div",
                                  { staticClass: "flex-1 ml-2  text-blue-600" },
                                  [
                                    _vm._v(
                                      "\n                                    Respuestas\n                                "
                                    )
      ...
      : _c(
          ...
          [
            _c(
              "div",
              { staticClass: "mb-4 p-4 shadow-md rounded-lg bg-gray-100" },
              [
                _c("div", { staticClass: "flex items-center" }, [
                  _c("div", { staticClass: "flex-shrink" }, [
                    _c("img", {
                      staticClass: "w-12 rounded-full",
                      attrs: {
                        src: _vm.comment.user.profile_photo_url,
                        alt: ""
                      }
                    })
                  ]),
                          ...
                          _c("div", { staticClass: "flex items-center" }, [
                            _c("div", { staticClass: "flex-shrink" }, [
                              _c(
                                "svg",
                                {
                                  staticClass: "w-6  text-green-600",
                                  attrs: {
                                    xmlns: "http://www.w3.org/2000/svg",
                                    fill: "none",
                                    viewBox: "0 0 24 24",
                            ...
                            _c(
                              "div",
                              { staticClass: "flex-1 ml-2  text-green-600" },
                              [
                                _vm._v(
                                  "\n                                    Regresar\n                                "
                                )
            ...
            _c(
              ...
              {
                staticClass:
                  "text-center shadow-md rounded-lg  mb-4 p-4 bg-white"
              },
              [
                _c("h2", { staticClass: "text-90 text-sm mb-4 text-left" }, [
                  _vm._v("Responder:")
