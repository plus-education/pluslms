<template>
  <div>
      ...
      <comments :activity="activity" :user="user" class="mt-4"></comments>
  </div>
</template>
...
<style>
    ...
    .editor-js-content .editor-js-block{padding:.7em 0}
    ...
    .editor-js-content p{line-height:1.6em}
    .editor-js-content li{padding:5.5px 0 5.5px 3px;line-height:1.6em}
