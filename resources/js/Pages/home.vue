           ...
           <section class="grid  lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
               <inertia-link v-for="course in courses"  :key="course.id"  :href="`/courses/${course.id}`">
                   <div class="p-2  w-full lg:max-w-full lg:flex">
                       <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url('/img/courses/cover1.jpg')" title="Woman holding a mug">
                       </div>
